...
/// @nodoc
class __$FetchCopyWithImpl<$Res> extends _$HomeEventCopyWithImpl<$Res>
...
class _$HomeStateTearOff {
  ...
  _Loaded loaded(List<HomeItem> items) {
    return _Loaded(
      items,
    );
  }
...
abstract class _Loaded implements HomeState {
  const factory _Loaded(List<HomeItem> items) = _$_Loaded;
